...
const account1 = {
  ...
  movementsDates: [
    ...
    '2021-08-01T07:42:02.383Z',
    '2021-08-05T09:15:04.904Z',
    '2021-08-10T10:17:24.185Z',
    '2021-08-11T14:11:59.604Z',
    '2021-08-12T17:01:17.194Z',
...
const loanTimer = function (amount) {
  if (amount < 1000) return 1000;
  if (amount >= 1000 && amount <= 9999) return 3000;
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // Clear the timer that is running when the
    if (timer) clearInterval(timer);

    // Starting timer for logging out
